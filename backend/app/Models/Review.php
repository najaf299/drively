...
class Review extends Model
{
    ...
    protected $fillable = [
        'booking_id', 'reviewer_id', 'reviewee_id', 'car_id', 'type',
        'rating', 'cleanliness_rating', 'communication_rating',
        'accuracy_rating', 'pickup_rating', 'comment', 'tags',
        'photo_urls', 'is_public',
    ];
